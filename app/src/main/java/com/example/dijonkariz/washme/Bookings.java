...
public class Bookings extends AppCompatActivity {
    ...
    private void prepareServiceData() {
        //        for the service
        ServiceItem a = new ServiceItem(getString(R.string.vehicle_suv));
        serviceItemList.add(a);

        a = new ServiceItem(getString(R.string.vehicle_sedan));
        serviceItemList.add(a);

        a = new ServiceItem(getString(R.string.vehicle_hatchback));
        serviceItemList.add(a);

        a = new ServiceItem(getString(R.string.vehicle_van));
        serviceItemList.add(a);

        a = new ServiceItem(getString(R.string.vehicle_convertible));
        serviceItemList.add(a);
    ...
    private void preparePackageData() {
        //        for the package
        PackageItem pa = new PackageItem(getString(R.string.vehicle_suv));
        packageItemList.add(pa);

        pa = new PackageItem(getString(R.string.vehicle_sedan));
        packageItemList.add(pa);

        pa = new PackageItem(getString(R.string.vehicle_hatchback));
        packageItemList.add(pa);

        pa = new PackageItem(getString(R.string.vehicle_van));
        packageItemList.add(pa);

        pa = new PackageItem(getString(R.string.vehicle_convertible));
        packageItemList.add(pa);
